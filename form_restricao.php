...
<?php include "templates.php"; ?>
 ...
 <body>
        ...
        <form> 	
          ...
          <label for="exampleInputPassword1">Matricula do Professor</label><br>
          <select name="matricula" id="matricula" class="select form-control">
            <option value="" disabled selected>Digite a Matricula do Professor</option>
            <option value="Matutino">Hugo</option>
          </select>
          </div> 

          <div class="container" align="left">
          <label for="exampleInputPassword4">Restrições de Horário de Professor</label>
          <table class="table table-hover" id="restricao" name="restricao">
              <tr>
